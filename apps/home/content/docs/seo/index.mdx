...
generateMetadata({
  ...
  path: "/page",           // Optional: for canonical URL
  baseUrl: "https://...",  // Optional: base URL for canonical
  siteName: "My App",      // Optional: site name for OpenGraph
  titleTemplate: "%s | My App", // Optional: title template
  image: "/og-image.png",  // Optional: OpenGraph image
