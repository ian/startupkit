...
description: How to track analytics events with @startupkit/analytics
---
...
import { useAnalytics as useBaseAnalytics } from "@startupkit/analytics"
...
- [Server-side tracking](/docs/analytics/advanced/server-side) - Track from your backend
