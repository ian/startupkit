...
See [PostHog setup](/docs/analytics/providers/posthog) for full configuration.

## Next Steps

- [PostHog provider](/docs/analytics/providers/posthog) - Configure PostHog feature flags
- [Custom routing](/docs/analytics/advanced/custom-routing) - Route events based on flags
