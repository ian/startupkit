---
title: Feature Flags
description: How to use feature flags with @repo/analytics
---
...
```typescript twoslash title="types/flags.ts"
...
import { useAnalytics, useFlag } from "@repo/analytics"
...
```tsx twoslash title="lib/analytics-server.ts"
// @noErrors
