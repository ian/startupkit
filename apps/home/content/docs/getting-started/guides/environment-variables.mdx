...
| Variable | Required | Description |
|----------|----------|-------------|
| `NEXT_PUBLIC_POSTHOG_API_KEY` | For PostHog | Client-side API key |
...
```bash
NEXT_PUBLIC_POSTHOG_API_KEY=phc_xxxxxxxxxxxx
...
| Variable | Required | Description |
|----------|----------|-------------|
| `NEXT_PUBLIC_GA_MEASUREMENT_ID` | For GA4 | GA4 measurement ID |
