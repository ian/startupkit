...
declare const db: { update: (t: unknown) => { set: (v: unknown) => { where: (c: unknown) => Promise<void> } }; select: () => { from: (t: unknown) => { where: (c: unknown) => Promise<unknown[]> } } }
declare const postId: string
// ---cut---
...
```tsx twoslash
// @noErrors
import { db, users, posts } from "@repo/db"
...
```tsx twoslash
// @noErrors
import { db, teams, teamMembers } from "@repo/db"
