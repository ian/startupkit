...
declare const sessionsTable: unknown
// ---cut---
...
declare const db: { select: () => { from: (t: unknown) => { where: (c: unknown) => Promise<{ id: string; userAgent: string; ipAddress: string }[]> } } }
declare const eq: (a: unknown, b: unknown) => unknown
declare const user: { id: string }
declare function revokeSession(id: string): void
// ---cut---
