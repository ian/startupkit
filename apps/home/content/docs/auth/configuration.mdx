...
```ts twoslash title="packages/auth/src/server.ts"
// @noErrors
...
```ts twoslash title="apps/web/app/auth/[...all]/route.ts"
// @noErrors
...
```ts twoslash title="packages/auth/src/index.ts"
// @noErrors
...
```tsx twoslash title="packages/auth/src/components/provider.tsx"
// @noErrors
"use client"
...
```tsx twoslash title="apps/web/app/providers.tsx"
// @noErrors
"use client"
...
```tsx twoslash title="apps/web/app/layout.tsx"
// @noErrors
